...
!!! warning "Deprecated"
    This extension has been deprecated.  Users are encouraged to use the [emoji extension](./emoji.md) instead.  This extension will be removed at some time in the future.
