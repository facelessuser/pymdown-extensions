...
- **NEW**: Upgrade EmojiOne to 4.5.0 using the latest JoyPixels' (formally EmojiOne) short name index. EmojiOne was rebranded as JoyPixels, but while the index is licensed under MIT, the image assets are no longer free. The Emoji extension will only reference the last free release of EmojiOne.
